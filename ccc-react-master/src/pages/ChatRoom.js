...
function ChatRoom() {
    ...
    const displayMessage = (sender, text = null, imageUrl = undefined, fileUrl = undefined, fileName = undefined) => {
        setMessages((prevMessages) => {
            if (prevMessages.some((msg) => msg.sender === sender && msg.text === text && msg.imageUrl === imageUrl && msg.fileUrl === fileUrl)) {
                return prevMessages;
            }
            return [...prevMessages, { sender, text, imageUrl, fileUrl, fileName }];
        });
